...
import com.entertainment.TelevisionChannelBrandComparator;
...
public class TelevisionTestSort {
    ...
    public static void main(String[] args) {
        ...
        tvList.sort(new TelevisionChannelBrandComparator());
        System.out.println("Sorted by Channel and brand");
        for (Television tv : tvList)
            System.out.println(tv);
